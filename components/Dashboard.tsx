  ...
  return (
    <div className="space-y-6">
        ...
        <div className="prose prose-blue max-w-none text-gray-700 text-sm leading-relaxed">
          {loading ? (
             <div className="flex items-center gap-2 text-blue-500 animate-pulse">
               <Loader2 className="animate-spin w-4 h-4" /> Analyzing team performance and retail KPIs...
             </div>
          ) : (
            insights ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Team Workload</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-blue-600 text-white p-5 rounded-xl shadow-lg shadow-blue-200">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h4 className="text-3xl font-bold mt-1">{tasks.length}</h4>
            </div>
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h4 className="text-3xl font-bold mt-1 text-gray-800">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-gray-500 text-sm font-medium">Pending Urgent</p>
              <h4 className="text-3xl font-bold mt-1 text-gray-800">
